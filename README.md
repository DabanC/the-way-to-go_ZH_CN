...
项目fork自 [Go入门指南](https://github.com/unknwon/the-way-to-go_ZH_CN)
为了方便移动阅读，制作了[pdf](pdf/the_way_to_go.pdf)版本,本项目地址 [https://github.com/DabanC/the-way-to-go_ZH_CN]( https://github.com/DabanC/the-way-to-go_ZH_CN)

请多多支持翻译者 [https://github.com/unknwon/the-way-to-go_ZH_CN](https://github.com/unknwon/the-way-to-go_ZH_CN)
